...
class AccountQuotationForm extends StatefulWidget {
  final String docId;
  const AccountQuotationForm({super.key, required this.docId});

  @override
  State<AccountQuotationForm> createState() => _AccountQuotationFormState();
}

class _AccountQuotationFormState extends State<AccountQuotationForm> {
  bool _loading = true;
  String _quoteNumber = "";
  String _partyName = "";
  String _jobName = "";
  ...
  Future<void> _loadData() async {
    try {
      ...
      if (snap.exists) {
        ...
        _quoteNumber = data["quoteNumber"] ?? widget.docId;
        _partyName = data["PartyName"] ?? "";
        _jobName = data["ParticularJobName"] ?? "";
      }
    } catch (e) {
      debugPrint("❌ Error: $e");
    }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection("quotations").doc(widget.docId).set({
        "quoteNumber": _quoteNumber,
        "PartyName": _partyName,
        "ParticularJobName": _jobName,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _infoCard([
              _infoRow("Quote Number", _quoteNumber),
              _divider(),
