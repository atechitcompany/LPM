            ...
            IgnorePointer(
              ...
              child: Opacity(
                ...
                child: NumberStepper(
                  step: 0.01,
                  initialValue:
                  double.tryParse(form.CapsuleRate.text) ?? 0,
            ...
            IgnorePointer(
              ...
              child: Opacity(
                ...
                child: NumberStepper(
                  step: 1,
                  initialValue:
                  double.tryParse(form.CapsulePcs.text) ?? 0,
            ...
            IgnorePointer(
              ...
              child: Opacity(
                ...
                child: NumberStepper(
                  step: 1,
                  initialValue:
                  double.tryParse(form.PerforationSize.text) ?? 0,
            ...
            IgnorePointer(
              ...
              child: Opacity(
                ...
                child: NumberStepper(
                  step: 1,
                  initialValue:
                  double.tryParse(form.ZigZagBladeSize.text) ?? 0,
            ...
            IgnorePointer(
              ...
              child: Opacity(
                ...
                child: NumberStepper(
                  step: 1,
                  initialValue:
                  double.tryParse(form.RubberSize.text) ?? 0,
            ...
            IgnorePointer(
              ...
              child: Opacity(
                ...
                child: NumberStepper(
                  step: 0.01,
                  initialValue:
                  double.tryParse(form.CourierCharges.text) ?? 0,
