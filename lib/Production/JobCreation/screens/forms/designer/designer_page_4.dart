...
class _DesignerPage4State extends State<DesignerPage4> {
  ...
  // 🚀 FETCH 1: Perforations from master_inventory
  Future<void> _fetchPerforations() async {
    try {
      ...
      setState(() {
        _perforationItems = ["No", ...items.toSet().toList()..sort()];
  ...
  // 🚀 FETCH 2: Zig Zag Blades from master_inventory
  Future<void> _fetchZigZagBlades() async {
    try {
      ...
      setState(() {
        _zigZagBladeItems = ["No", ...items.toSet().toList()..sort()];
  ...
  // 🚀 FETCH 3: Rubbers from master_inventory
  Future<void> _fetchRubbers() async {
    try {
      ...
      setState(() {
        _rubberItems = ["No", ...items.toSet().toList()..sort()];
  ...
  // 🚀 FETCH 4: Holes from master_inventory
  Future<void> _fetchHoles() async {
    try {
      ...
      setState(() {
        _holeItems = ["No", ...items.toSet().toList()..sort()];
        _loadingHoles = false;
      });
    } catch (e) {
